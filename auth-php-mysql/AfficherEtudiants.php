        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
             ...
             <a class="dropdown-item" href="afficherpar.php">Etudiants par Groupe</a>
...
<button  class="btn btn-primary btn-block active" type="submit" onclick="refresh()">Actualiser</button>

<script>
    function refresh() {
        var xmlhttp = new XMLHttpRequest();
        var url = "http://localhost/mini/auth-php-mysql/afficher.php";
	...
	function myFunction(response){
		...
		var i;
		var out="<table class='table table-striped table-hover' ><tr><th> CIN </th> <th>  Nom</th> <th> Prénom</th> <th> Email </th> <th> Classe </th> </tr>";
