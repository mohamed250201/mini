...
<main role="main">
        <div class="jumbotron">
            <div class="container">
              ...
              <p>Remplir le formulaire ci-dessous afin de supprimer un etudiant!</p>
            </div>
          </div>


<div class="container">
 <form id="myForm" method="POST" action="supprimerE2.php">
     <!--Nom-->
     <div class="form-group">
     <label for="cin">cin du etudiant:</label><br>
...
<script>
    function supprimer()
    {
        ...
        var url="http://localhost/mini/auth-php-mysql/supprimerE2.php";
        ...
        {       
                if(this.readyState==4 && this.status==200){
                  // alert(this.responseText);
                    ...
                    {
                        document.getElementById("demo").innerHTML="La suppression du etudiant a été bien effectué";
                        document.getElementById("demo").style.backgroundColor="green";
                    }
                   /* else
                    {
                        document.getElementById("demo").innerHTML="Le etudiant  encore existe!";
