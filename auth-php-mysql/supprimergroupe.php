...
<div class="container">
 <form id="myForm" method="POST" action="supprimer2.php">
     <!--Nom-->
...
<script>
    function supprimer()
    {
        ...
        var url="http://localhost/mini/auth-php-mysql/supprimer2.php";
        ...
        {       
                if(this.readyState==4 && this.status==200){
                  alert(this.responseText);
                    ...
                    {
                        document.getElementById("demo").innerHTML="Le groupe encore existe!";
